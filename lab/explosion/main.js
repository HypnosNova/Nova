...
app.world.camera.position.set( 0, 0, 250 );
...
function init() {
	...
	new THREE.FontLoader().load( 'font/loadFont.js', function( font ) {
		var mesh1 = createManyAnimationMesh( [ new THREE.BoxGeometry( 30, 30, 30, 3,
			3, 3 ), new THREE.BoxGeometry( 30, 30, 30, 3, 3, 3 ), new THREE.BoxGeometry(
			30, 30, 30, 3, 3, 3 ) ], [ {
			x: 0,
			y: 0,
			z: 0
